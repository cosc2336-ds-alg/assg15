...
public:
  ...
  APriorityQueue(int size, T values[]); // array based constructor

  // accessors and information methods
  T front() const;
  string str() const;

  // declare public methods implementing Queue api like enqueue and dequeue here

private:
  void exchange(T& valueA, T& valueB);

  // declare private methods like fixDown and fixUp here
};
